			...
			<Carousel
				...
				<div>
					<h6 style={{ ...contentStyle, ...background1 }}>
						...
						fortress known for its massive column of rock that
						reaches nearly 200 meters high. The site dates back
						to the reign of King Kasyapa (477-495 AD), who
						chose this site as his new capital. He decorated
						the walls with frescoes, and built an impressive
						palace right on top of the rock column, accessible
						only through the mouth of an enormous carved lion.
					</h6>
				</div>
				<div>
					<h6 style={{ ...contentStyle, ...background2 }}>
						...
						foreign devotees and tourists daily was named as a
				...
				<div>
					<h6 style={{ ...contentStyle, ...background3 }}>
						...
						out of coconut nectar. It also has a turtle
						hatchery, located on Induruwa beach.
					</h6>
				</div>
				<div>
